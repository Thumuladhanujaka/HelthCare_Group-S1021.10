	                ...
	                <div class="card">
	                    ...
	                    <div class="card-body">
	                        <form id="payment">
	                            ...
	                            <div class="form-group row">
	                                ...
	                                <div class="col-md-6">
	                                	<select name="visitId" class="form-control" onchange="details()" id="visitId">
											...
											%>
												<option value="<%=visit.getId() %>"><%=visit.getName() %> (<%=visit.getDate() %> in <%=visit.getHname() %>) </option>
											<%
												}
											%>
	                                	</select>
	                            ...
	                            <div class="form-group row">
	                                <label for="email_address" class="col-md-4 col-form-label text-md-right">Package / Price</label>
	                                <div class="col-md-6">
