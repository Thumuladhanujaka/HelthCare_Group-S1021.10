	                ...
	                <div class="card">
	                	...
	                	<%
							...
							for (Visit visit : arrayList) {
								...
								String button = "<button type='button' onclick='edit("+visit.getId()+")' class='btn btn-success'>Edit</button><button type='button' onclick='deletes("+visit.getId()+")' class='btn btn-danger'>Delete</button>";
								
						%><tr>
							<td class="tableTh"><%=visit.getId() %></td>
							<td class="tableTh"><%=visit.getName() %></td>
							<td class="tableTh"><%=visit.getDate() %></td>
							<td class="tableTh"><%=visit.getTime() %></td>
							<td class="tableTh"><%=visit.getHname() %></td>
...
<script>
    ...
    function edit(id) {
    	...
    	$.ajax({
            type: "POST",
            url: "<%= request.getScheme()+"://"+request.getServerName()+":"+request.getServerPort()+request.getContextPath() %>/rest/visit/getOne",
    ...
    function deletes(id) {
    	...
    	$.ajax({
            type: "POST",
            url: "<%= request.getScheme()+"://"+request.getServerName()+":"+request.getServerPort()+request.getContextPath() %>/rest/visit/deletes",
            data: JSON.stringify({ 'id' : id}),
            dataType: "json",
			contentType : 'application/json',
            success: function(data){
    ...
    $(document).ready(function () {
        ...
        $("#editForm").validate({
            ...
            submitHandler: function () {
                ...
                $.ajax({
                    type: "POST",
                    url: '<%= request.getScheme()+"://"+request.getServerName()+":"+request.getServerPort()+request.getContextPath() %>/rest/visit/edit',
                    dataType : 'json',
    				contentType : 'application/json',
    				data: datas,
                    success: function(data){
