	            ...
	            <div class="col-md-8">
	                <div class="card">
	                    	...
	                    	<table class="table">
			                    <thead>
					                <tr>
					                    ...
					                    <th class="tableTh">Patient Name</th>
	                	...
	                	<%
							...
							ArrayList<Lab> arrayList = labs.getLabs();
							
							for (Lab lab : arrayList) {
								
								String button = "<button type='button' onclick='edit("+lab.getId()+")' class='btn btn-success'>Edit</button><button type='button' onclick='deletes("+lab.getId()+")' class='btn btn-danger'>Delete</button>";
								
						%><tr>
							<td class="tableTh"><%=lab.getId() %></td>
							<td class="tableTh"><%=lab.getName() %></td>
							<td class="tableTh"><%=lab.getDate() %></td>
							<td class="tableTh"><%=lab.getDescription() %></td>
							<td class="tableTh"><%=lab.getTest() %></td>
    ...
    <div class="modal-content1" style="height: 70%">
        ...
        <div class="col-md-12">
            <form  id="editForm">
                ...
                <div class="form-group">
                    <label for="message">Test Name</label>
...
<script>
    ...
    function edit(id) {
    	...
    	$.ajax({
            type: "POST",
            url: "<%= request.getScheme()+"://"+request.getServerName()+":"+request.getServerPort()+request.getContextPath() %>/rest/lab/getOne",
    ...
    function deletes(id) {
    	...
    	$.ajax({
            type: "POST",
            url: "<%= request.getScheme()+"://"+request.getServerName()+":"+request.getServerPort()+request.getContextPath() %>/rest/lab/deletes",
            data: JSON.stringify({ 'id' : id}),
            dataType: "json",
			contentType : 'application/json',
            success: function(data){
    ...
    $(document).ready(function () {
        ...
        $("#editForm").validate({
            ...
            submitHandler: function () {
                ...
                $.ajax({
                    type: "POST",
                    url: '<%= request.getScheme()+"://"+request.getServerName()+":"+request.getServerPort()+request.getContextPath() %>/rest/lab/edit',
                    dataType : 'json',
    				contentType : 'application/json',
    				data: datas,
                    success: function(data){
