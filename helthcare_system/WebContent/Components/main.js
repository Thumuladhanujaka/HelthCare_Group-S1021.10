...
function validateVisitForm() {
	// NAME
	/*
	 * if ($("#txtName").val().trim() == "") { return "Insert student name."; } //
	 * GENDER if ($('input[name="rdoGender"]:checked').length === 0) { return
	 * "Select gender."; } // YEAR if ($("#ddlYear").val() == "0") { return
	 * "Select year."; }
	 */
...
/*
 * function getStudentCard(name, gender, year) { var title = (gender == "Male") ?
 * "Mr." : "Ms."; var yearNumber = "";
 * 
 * switch (year) { case "1": yearNumber = "1st"; break; case "2": yearNumber =
 * "2nd"; break; case "3": yearNumber = "3rd"; break; case "4": yearNumber =
 * "4th"; break; }
 * 
 * var student = ""; student += "<div class=\"student card bg-light m-2\"
 * style=\"max-width: 10rem; float: left;\">"; student += "<div
...
{  // Clear status msges-------------
	...
	var student = getStudentCard($("#txtName").val().trim(),  
			...
			$("#ddlYear").val());  $("#colStudents").append(student);   
